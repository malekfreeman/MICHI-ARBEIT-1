...
contract BaseV1Pair {
    ...
    bytes32 internal constant PERMIT_TYPEHASH = 0x516271bbd510671c286a2d724913baaeefeed98a8db417ad43b190435e6372eb;
    ...
    // this low-level function should be called from a contract which performs important safety checks
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock gasThrottle {
    ...
    function setFee(uint256 _fee) external {
        require(msg.sender == IBaseV1Factory(factory).feeAmountOwner() || msg.sender == IBaseV1Factory(factory).admin() , "Pair: only factory's feeAmountOwner or admin");
